...
export const metadata: Metadata = {
  ...
  // ページの説明 (SEO対策)
  description: 'Next.js, Python, AI連携、LINE/Discordボット開発に特化したフルスタックエンジニアのポートフォリオ。Z世代のトレンドと技術力を融合させ、斬新なアプリケーションを開発します。',
  
  // 関連キーワード
  keywords: ['Next.js', 'React', 'TypeScript', 'Python', 'AI', 'Gemini', 'LINE Bot', 'Discord Bot', 'フルスタック', 'ポートフォリオ', 'Z世代'],
